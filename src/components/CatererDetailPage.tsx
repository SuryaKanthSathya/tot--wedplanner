...
export const CatererDetailPage: React.FC<CatererDetailPageProps> = ({
  ...
  // Curated 24 luxury catering setup and gourmet banquet photos
  const portfolioImages = [
    caterer.image,
    'https://images.unsplash.com/photo-1555244162-803834f70033?auto=format&fit=crop&w=1200&q=85',
    'https://images.unsplash.com/photo-1628294895950-9805252327bc?auto=format&fit=crop&w=1200&q=85',
