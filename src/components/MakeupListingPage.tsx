...
export const MAKEUP_STUDIOS_DATA: MakeupStudio[] = [
  ...
  },
  {
    ...
    portfolio: [
      ...
      'https://images.unsplash.com/photo-1522337094846-8a83858c3d6f?auto=format&fit=crop&w=800&q=80',
  ...
  },
  {
    ...
    priceValue: 22000,
    tier: 'Essential',
    image: 'https://images.unsplash.com/photo-1522337094846-8a83858c3d6f?auto=format&fit=crop&w=800&q=80',
    ...
    portfolio: [
      'https://images.unsplash.com/photo-1500840218059-b1d0017a6689?auto=format&fit=crop&w=800&q=80',
      'https://images.unsplash.com/photo-1595476108010-b4d1f102b1b1?auto=format&fit=crop&w=800&q=80',
      'https://images.unsplash.com/photo-1608248597261-8f336a6bc3d3?auto=format&fit=crop&w=800&q=80',
  ...
  },
  {
    ...
    portfolio: [
      ...
      'https://images.unsplash.com/photo-1502035615174-a621c45d3e0b?auto=format&fit=crop&w=800&q=80',
      'https://images.unsplash.com/photo-1576426863848-c21f53c60b19?auto=format&fit=crop&w=800&q=80',
      'https://images.unsplash.com/photo-1596704017351-419163ef22a0?auto=format&fit=crop&w=800&q=80',
    ],
  },
  {
    id: 'makeup-9',
  ...
  },
  {
    ...
    priceValue: 26000,
    tier: 'Premium',
    image: 'https://images.unsplash.com/photo-1500840218059-b1d0017a6689?auto=format&fit=crop&w=800&q=80',
      ...
      <AnimatePresence>
        {showCityDropdown && (
          <motion.div
            ...
            exit={{ opacity: 0, y: -10 }}
            className="absolute top-[138px] left-4 right-4 z-40 bg-white rounded-2xl p-3 shadow-xl border border-[#E8DFD5] max-h-[220px] overflow-y-auto flex flex-col gap-1"
          >
            {TAMIL_NADU_DISTRICTS.map((district) => (
              <TouchableOpacity
                key={district}
                style={[styles.dropdownOption, selectedCity === district && styles.dropdownOptionActive]}
                onPress={() => {
                  setSelectedCity(district);
                  setShowCityDropdown(false);
                }}
              >
                <Text style={[styles.dropdownOptionText, selectedCity === district && styles.dropdownOptionTextActive]}>
                  {district}
                </Text>
                {selectedCity === district && <Check className="w-4 h-4 text-[#581420]" />}
              </TouchableOpacity>
            ))}
          </motion.div>
        )}
      ...
      <AnimatePresence>
        {showSpecializationDropdown && (
          <motion.div
            ...
            className="absolute top-[138px] left-4 right-4 z-40 bg-white rounded-2xl p-3 shadow-xl border border-[#E8DFD5] max-h-[220px] overflow-y-auto flex flex-col gap-1"
          >
            {MAKEUP_SPECIALIZATIONS.map((spec) => (
              <TouchableOpacity
                key={spec}
                style={[styles.dropdownOption, selectedSpecialization === spec && styles.dropdownOptionActive]}
                onPress={() => {
                  setSelectedSpecialization(spec);
                  setShowSpecializationDropdown(false);
                }}
              >
                <Text style={[styles.dropdownOptionText, selectedSpecialization === spec && styles.dropdownOptionTextActive]}>
                  {spec}
                </Text>
                {selectedSpecialization === spec && <Check className="w-4 h-4 text-[#581420]" />}
              </TouchableOpacity>
            ))}
          </motion.div>
        )}
      ...
      <AnimatePresence>
        {showBudgetDropdown && (
          <motion.div
            ...
            animate={{ opacity: 1, y: 0 }}
            exit={{ opacity: 0, y: -10 }}
            className="absolute top-[138px] left-4 right-4 z-40 bg-white rounded-2xl p-3 shadow-xl border border-[#E8DFD5] flex flex-col gap-1"
          >
            {BUDGET_RANGES.map((b) => (
              <TouchableOpacity
                key={b}
