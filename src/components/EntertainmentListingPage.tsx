...
export const EntertainmentListingPage: React.FC<EntertainmentListingPageProps> = ({
  ...
  const savedEntsList = ENTERTAINMENT_DATA.filter((e) => Boolean(bookmarkedIds[e.id]));
  ...
  return (
    <View style={styles.container}>
          ...
          >
            ...
            >
              <View style={styles.floatingCompareBadge}>
                <Text style={styles.floatingCompareBadgeText}>{savedEntsList.length}</Text>
              </View>
              <Scale className="w-4 h-4 text-white mr-1.5" />
              <Text style={styles.floatingCompareBtnText}>Compare ({savedEntsList.length})</Text>
      ...
      <VendorCompareModal
        ...
        categoryTitle="Entertainment Artists"
        vendors={savedEntsList}
