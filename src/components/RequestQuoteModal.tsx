    ...
    <AnimatePresence>
      {visible && (
        <motion.div
          ...
          className="fixed inset-0 z-[9999] flex flex-col justify-end bg-black/65 cursor-pointer"
        ...
        >
          <motion.div
            ...
            className="w-full max-w-2xl mx-auto bg-[#FAF7F2] rounded-t-3xl p-4 pt-5 pb-6 relative max-h-[88%] flex flex-col shadow-2xl cursor-default"
