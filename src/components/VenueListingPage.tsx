...
export const VENUES_DATA: VenueItem[] = [
  {
    ...
    portfolio: [
      ...
      'https://images.unsplash.com/photo-1545232979-fbf582231e33?auto=format&fit=crop&w=800&q=80',
    ],
    packages: [
      {
  ...
  },
  {
    ...
    capacityValue: 2000,
    image: 'https://images.unsplash.com/photo-1545232979-fbf582231e33?auto=format&fit=crop&w=800&q=80',
    description:
